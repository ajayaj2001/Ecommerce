...
namespace Customer.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        {
            //is username exist
            UserCredential userCredential = _authServices.GetUserByEmail(loginCredentials.EmailAddress);
            ...
            //is password same
            bool check = _authServices.ComparePassword(userCredential.Password, loginCredentials.Password);
            if (!check)
            {
            ...
            AuthenticationResponse authenticationResponse = _jwtTokenHandler.GenerateJwtToken(new AuthenticationRequest() { Role = userCredential.Role, EmailAddress = userCredential.EmailAddress,Id= userCredential.UserId });
