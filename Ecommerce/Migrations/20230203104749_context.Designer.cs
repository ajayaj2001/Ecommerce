...
namespace Customer.Migrations
{
    ...
    [Migration("20230203104749_context")]
            ...
            modelBuilder.Entity("Customer.Entities.Models.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d5dbdeba-4374-49d7-b419-4264fac23e4c"),
                            City = "chennai",
                            Country = "tamil nadu",
            ...
            modelBuilder.Entity("Customer.Entities.Models.CardDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("916d820c-da4c-4771-8e89-8fc029eeeb30"),
                            CVVNo = "233",
            ...
            modelBuilder.Entity("Customer.Entities.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = "01-01-0001 12:00:00 AM",
                            CreatedBy = new Guid("b8473c2b-f7c1-443e-88f1-acdca9abaf5e"),
            ...
            modelBuilder.Entity("Customer.Entities.Models.UserCredential", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0c4e13fb-abe0-45f3-a1c6-b55c2df8c15a"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsActive = true,
                            Password = "tester2001",
                            Role = "customer",
